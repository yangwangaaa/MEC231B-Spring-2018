...
linDyn = load('bicycle_lindyn.mat');
...
for i=1:N
    ...
    xk = xEst(:,i);
    p = [params.m; params.Jz; params.a; params.b; params.A ...
        ;params.B; params.C; params.dt];
    [Ak,~,Ck,~] = getLinearDynamics_at_k(xk,uk,p); [xk1k,Sxk1k, ykk1] = myEKF231B(xk,xVar(:,:,i),...
